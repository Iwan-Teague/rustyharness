...
**Status:** v0.2, 2026-09-23 — reviewed **SOUND** (first review NEEDS-FIXES; rework; confirming review SOUND with two LOW clarifications, applied). H1 built (slices H1a-H1f), its phase-exit review next: clarifications made while building are listed in "Changes since v0.2"; none changes the architecture.
